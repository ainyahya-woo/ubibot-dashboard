                ...
                for channel in data['channels']:
                    ...
                    if 'gs1' in device_name or 'agricultural' in device_name or 'sensor' in device_name:
                        result['gs1_sensor'] = {
                            ...
                            'soil_temperature': last_values.get('field10'),
                            'soil_humidity': last_values.get('field8'),
                            'soil_ec': last_values.get('field7'),
                            'soil_ph': last_values.get('field9')
                        }
                    ...
                    # Identify Smart Plug (check name contains 'plug' or 'socket')
                        ...
                        result['smart_plug'] = {
                            ...
                            'carbon_dioxide': last_values.get('field7')
                        }
                            ...
                            if 'gs1' in device_name or 'agricultural' in device_name or 'sensor' in device_name:
                                for feed in history_data['feeds'][:100]:
                                    result['gs1_sensor'].append({
                                        ...
                                        'soil_temperature': feed.get('field10'),
                                        'soil_humidity': feed.get('field8')
                                    })
